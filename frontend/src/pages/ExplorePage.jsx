...
const ExplorePage = () => {
	return (
		<div className='px-4'>
			<div className='bg-clip-padding backdrop-filter backdrop-blur-md border bg-opacity-10 hover:bg-gray-600/10 border-gray-800 text-white
			 max-w-2xl mx-auto rounded-md p-4'>
